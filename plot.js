...
{
	//drawing data
	let axisX = height - 64, axisLeft = 32, axisRight = width - axisLeft;
	let axisTop = 32, axisBottom = height - axisTop;

	let pointLeft = axisLeft + 96, pointRigth = axisRight - 96, pointHeight = axisTop + 64 - axisX, dashSz = 8;
	let pointDx = (pointRigth - pointLeft) / (points_data[points_data.length - 1].x - points_data[0].x);
	let axisY = pointLeft - pointDx * points_data[0].x;
